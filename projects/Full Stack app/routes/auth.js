...
router.post('/createuser',
    ...
    async (req, res) => {
        ...
        try {
            ...
            res.status(500).json({ error: error.massage, code_block: "/login catch block", type: "server error" })
        }
...
router.post('/login',
    ...
    async (req, res) => {
        ...
        try {
            ...
            res.status(500).json({ error: error.massage, code_block: "/login catch block" })
        }
    },
);
...
router.get('/getuser',
    ...
    async (req, res) => {
        try {
            ...
            res.status(500).json({ error: error.massage, code_block: "/getuser catch block" })
        }
    },
);
